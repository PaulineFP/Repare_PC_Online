...
<head>
    ...
    <link rel="stylesheet" href="technext.github.io/consultingbiz/assets/css/responsive.css">
</head>
...
<main>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="right-caption">
                        ...
                        <div class="support-caption">
                            <p class="pera-top">L'environnement de travail est donc stimulant pour les étudiants mais il
                                permet également à l'équipe pédagogique de donner un sens et
                                une vision concrète des apports théoriques, même si nos formations sont orientées à 90%
                                sur des cas pratiques "pédagogiques".</p>
                            <p class="mb-65">Nos techniciens informatiques en herbe bénéficient de différents outils et
                                différents logiciels pour pouvoir mener à
                                bien leur mission. Si vous voulez profiter de ce service, vous avez également à votre
                                disposition un formulaire de contact qui vous permettra d'être mis en relation avec le
                                centre le plus proche.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 mb-125">
                    <div class="about-details-cap mb-50 justify-content-around">
                        ...
                        <p>Dès sa création en 1999, ONLINEFORMAPRO s’est rapidement imposée comme une entreprise
                            innovante dans le domaine de la pédagogie inversée et pédagogie active par projet.</p>
                        <p> En effet, entre Digital Learning et organisme de formation reconnu, notre culture
                            pédagogique présente dans nos 21 sites en Bourgogne – Franche-Comté,
                            Grand Est et Rhône-Alpes nous a permis d’accélérer la mutation de la formation via des
                            solutions innovantes et adaptées notamment dans les métiers de l’informatique.</p>
                    </div>

                    <div class="about-details-cap mb-50 justify-content-around">
                        <h4>Notre Vision</h4>
                        <p>Le projet "REPARE PC" initié par ONLINRFORMAPRO est né de la volonté de faire participer
                            activement nos apprenants sur des cas
                        ...
                        <p>Il suffit de proposer ses compétences en informatique gratuitement et intervenir sur des
                            pannes réelles et des besoins
                            spécifiques émanant de véritables clients (professionnels ou particuliers).</p>
                    </div>

                    <div class="about-details-cap mb-50 justify-content-around">
                        <h4>Notre Objectif</h4>
                        <p>En ouvrant nos portes pendant deux après-midi par semaine en tant que centre de diagnostics
                            et de réparations gratuit et accessible au public, notre objectif est de permettre aux
                            apprenants de mettre en avant leurs apprentissages pratiques et théoriques abordés en centre
                            et même de prolonger leurs connaissances
                        ...
                        <p>Nous avons donc vocation à confronter nos apprenants sur des projets et incidents réels afin
                            qu’ils soient opérationnels à l’issue de leur formation de technicien informatique. Ils
                            pourront également réaliser une intervention à distance si vous
                            le souhaitez et vous donner toutes les explications nécessaires à la bonne utilisation de
                ...
                <div class="col-6 order-sm-2">
                    ...
                    <div>
                        <form class="form-contact contact_form"
                              action="technext.github.io/consultingbiz/contact.php"
                              method="post" id="contactForm">
                            <div class="row">
                                <div class="col-sm-6" style="display: none;">
                                    <div class="form-group">
                                        <input class="form-control" name="namecenter" id="contact_center"
                                               type="text"
                    ...
                    <div class="offset-lg-1">
                        <div class="media contact-info">
                            <div class="media-body">
                                <img class="consigne img-fluid"
                                     src="technext.github.io/consultingbiz/assets/img/gallery/consigne.png">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="contact-section">
        <div class="container">
            ...
            <div class="about-details section-padding30">
                <div class="col-12 text-center pb-5">
                    <h4>Vous êtes une entreprise ou une association qui souhaite se débarrasser de matériels
                        informatiques obsolètes ??!!</h4>
                </div>
                <div class="row">
                    <div class="col-6">
                        <img class="consigne img-fluid"
                             src="technext.github.io/consultingbiz/assets/img/gallery/recuperation.jpg">
                    </div>

                    <div class="col-6 about-details-cap pt-5">
                        <h4>Pour la bonne cause</h4>
                        <p>Toujours dans cet esprit et cette volonté de faire participer activement nos
                            apprenants
                            sur des cas concrets de maintenance ou
                            télémaintenance informatique, « REPARE PC » vous propose de récupérer ce type de
                            matériel. En effet, plutôt que de faire appel à une entreprise de recyclage,
                            nos apprenants proposent de reconditionner votre ancien matériel pour les
                            redistribuer à
                            des familles dans le besoin ou à des associations d'aide à l'emploi.
                        </p>
                        <img class="eco mx-5 xs-mx-0"
                             src="technext.github.io/consultingbiz/assets/img/gallery/ecolog.jpg">
                    </div>
                </div>
            </div>
        </div>
